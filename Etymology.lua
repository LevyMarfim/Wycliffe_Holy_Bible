...
heuene = {
	...
	phonetic = "ˈhɛv(ə)n",
	class = "noum",
	meaning = [[From OE \textit{heofon} ``home of God,'' earlier ``the visible sky, firmament,'' probably from Proto-Germanic *\textit{hibin}-, a dissimilation of *\textit{himin}- (source also of Low German \textit{heben}, ON \textit{himinn}, Gothic \textit{himins}, OF \textit{himul}, Dutch \textit{hemel}, German \textit{Himmel} ``heaven, sky''). The abode of God, heaven, paradise.]]
}
